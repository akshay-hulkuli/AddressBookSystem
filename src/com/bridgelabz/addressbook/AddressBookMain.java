...
public class AddressBookMain {
	...
	public static void main(String[] args) {
		...
		boolean exit1 = true;
		while(exit1) {
			System.out.println("Select option 1:Add address Book 2:open Address Book  3:search person in a city or state  4 : display users in city or state 5: count city or state 6:exit");
			switch(sc.nextInt()) {
				case 1: 
